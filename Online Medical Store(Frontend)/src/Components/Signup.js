...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios.post("https://localhost:7156/api/Users", inputs).then(
      (response) => {
        ...
        <Paper elevation={5} style={!isMatch ? paperStyle : smallDev}>
          <Grid align="center">
            <Avatar sx={{ width: 60, height: 60 }}>
              <AccountCircleRoundedIcon
                sx={{ fontSize: 60, backgroundColor: "#008080" }}
              />
            </Avatar>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <TextField
              ...
              required
            />
            <FormControl sx={{ mt: 0.5, marginRight: "170px" }}>
              <FormControlLabel
                control={
                  <Checkbox
            ...
            >
              ...
              <span style={{ fontWeight: "bold", marginLeft: 5 }}> Login</span>
            </Button>
          </form>
        </Paper>
      </Grid>
